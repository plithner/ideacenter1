...
*/
	...
	return array(
		'a_commented_body' => "Your contribution to ^site_title has a new comment by ^c_handle:\n\n^open^c_content^close\n\nYour contribution was:\n\n^open^c_context^close\n\nYou may respond by adding your own comment:\n\n^url\n\nThank you,\n\n^site_title",
		'a_commented_subject' => 'Your ^site_title contribution has a new comment',

		'a_followed_body' => "Your contribution to ^site_title has a new related idea by ^q_handle:\n\n^open^q_title^close\n\nYour contribution was:\n\n^open^a_content^close\n\nClick below to contribution to the new idea:\n\n^url\n\nThank you,\n\n^site_title",
		'a_followed_subject' => 'Your ^site_title contribution has a related idea',

		'a_selected_body' => "Congratulations! Your contribution to ^site_title has been selected as the best by ^s_handle:\n\n^open^a_content^close\n\nThe idea was:\n\n^open^q_title^close\n\nClick below to see your contribution:\n\n^url\n\nThank you,\n\n^site_title",
		'a_selected_subject' => 'Your ^site_title contribution has been selected!',
		...
		'q_posted_body' => "A new idea has been shared by ^q_handle:\n\n^open^q_title\n\n^q_content^close\n\nClick below to see the idea:\n\n^url\n\nThank you,\n\n^site_title",
